...
export default function Credentials() {
  ...
  /* Lock page scrolling while certificate is open */
  useEffect(() => {
    if (!selected) return
  ...
  return (
    <section
      id="certificates"
      className="section certificates-section horizontal-showcase-section"
    >
      <div className="shell">
        <div className="section-row-head reveal">
          <div>
            ...
            <h2>
              Verified learning and professional milestones.
            </h2>
          </div>
        ...
        <div className="certificate-intro-panel reveal">
          <div>
            ...
            <h3>
              Industry credentials and continuous
              professional development.
            </h3>
          </div>

          <p>
            Explore verified certifications, internships,
            training programs and professional milestones.
          </p>
        </div>
      </div>

      <div
        className="auto-showcase certificate-auto-showcase"
